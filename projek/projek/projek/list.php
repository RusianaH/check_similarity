...
<html lang="en">
  ...
  <div id="content-wrapper">
                        ...
                        <div class="card-body">          
                            <div class="table-responsive">
							    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = mysqli_query($connection, "SELECT * FROM files ORDER BY nim desc");
                                            $no =1;
                                            foreach($sql as $files){
                                                ...
                                                <tr width="250">
                                                    ...
                                                    <td>
                                                    <td>
                                                        <a href="edit.php?id=<?= $files['id']; ?>"
                                                             class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                        <a href="proses-hapus.php?id=<?= $files['id']; ?>" onclick="return confirm('anda yakin ?');"
    ...
    <footer>
      ...
      <?php require './_partials/modal.php'?>
</body>
</html>
