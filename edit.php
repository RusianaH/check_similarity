...
if( !isset($_GET['id']) ){
    header('Location: edit.php?status=sukses');
} 
...
$sql = mysqli_query($connection, "SELECT * FROM  files  WHERE id='$id' ");
...
<html lang="en">
  ...
  <?php 
      ...
      if($_SESSION['role']==""){
          header("location:list-user.php?pesan=maaf perlu persetujuan admin");
      }
  ...
  <div id="content-wrapper">
      ...
      <div class="col-md-12 p-5 pt-2">
          <h3><i class="fas fa-folder-plus"></i> Edit File</h3><hr>
            <div id="content-wrapper">
              ...
              <div class="row">
                <div class="col-md-12">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="nama" id="" aria-describedby="helpId" placeholder="Input Nama Lengkap" value="<?php echo $files['nama'] ?>" >
                              <small id="helpId" class="form-text text-muted">Masukkan nama</small>
                          </div>

                          <div class="form-group">
                              <label for="">Nim</label>
                              <input type="number" class="form-control" name="nim" id="" aria-describedby="helpId" placeholder="Input Nim" value="<?php echo $files['nim'] ?>">
                              <small id="helpId" class="form-text text-muted">Masukkan Nim</small>
                          </div>

                          <div class="form-group">
                              <label for="">Judul</label>
                              <input type="text" class="form-control" name="judul" id="" aria-describedby="helpId" placeholder="Input judul" value="<?php echo $files['judul'] ?>">
                              <small id="helpId" class="form-text text-muted">Masukkan judul</small>
                          </div>

                          <div class="form-group">
                              <label for="">Tahun</label>
                              <input type="current_timestamp" class="form-control" name="tahun" id="" aria-describedby="helpId" placeholder="Input file tahun" value="<?php echo $files['tahun'] ?>">
                              <small id="helpId" class="form-text text-muted">Masukkan File tahun dibuat</small>
                          </div>
                          
                          <div class="form-group">
                              <label for="">Deskripsi / Keterangan</label>
                              <input type="text" class="form-control" name="deskripsi" id="" aria-describedby="helpId" placeholder="Input keterangan" value="<?php echo $files['deskripsi'] ?>">
